...
public class ExceptDb extends Except4Support
{
    ...
    private ExceptDb(String errorCode, String message, String extendedMessage, Throwable cause) {
        ...
        host = System.getenv("market_Db_url"); //getProperty() for server. getenv() for local.
        username = System.getenv("market_Db_user"); //getProperty() for server. getenv() for local.
    }
